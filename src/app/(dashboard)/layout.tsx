...
export const metadata = {
  title: 'Empowerment | Dashboard',
  description: 'PENERAPAN MODEL PROTOTYPE PADA PERANCANGAN APLIKASI PELAPORAN KASUS PEMBERDAYAAN PEREMPUAN DAN ANAK BERBASIS ANDROID.',
}
